"""Generalized reviewer agent.

Single agent class for ALL review types (paper, grant, proposal, deliverable, etc.).
Behavior is entirely config-driven: system_prompt + skills determine what the reviewer
evaluates and how. The agent itself is a thin 2-node pipeline (analyze → respond).
...
class ReviewerAgent(BaseAgent):
    """General-purpose reviewer agent.

    Works for any review type — paper, grant, proposal, deliverable, etc.
    ...
    name = "reviewer"
    description = "General-purpose reviewer agent. Config-driven: system_prompt and skills determine the review type and methodology."
